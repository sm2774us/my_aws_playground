...
- [My AWS Playground](#my-aws-playground)
  ...
  - [**IAM: What is it and what are the options**](#iac-what-is-it-and-what-are-the-options)
    <details>
    <summary>Click to expand!</summary>
  ...
  - [**AWS: Examples**](#aws-examples)
    ...
    - [AWS: Java Examples](#aws-java-examples)
      - [Springboot Fargate CDK](#springboot-fargate-cdk)	
    - [AWS: TypeScript Examples](#aws-typescript-examples)
      - [Full stack with Next.js, Amplify, and CDK](#full-stack-with-nextjs-amplify-and-cdk)	
      - [Full Stack Cloud with Next.js, Tailwind, and AWS](#full-stack-cloud-with-nextjs-tailwind-and-aws)
    - [AWS: Python Examples](#aws-python-examples)
      - [ML classifier on the cloud with AWS CDK](#ml-classifier-on-the-cloud-with-aws-cdk)
...
> `app.py`
>
> [app.py](./IaC_UnitTesting/cdk/python/lambda-cron/app.py)
>
...
> `test_lambda-cron.py`
>
> [test_lambda-cron.py](./IaC_UnitTesting/cdk/python/lambda-cron/test_lambda-cron.py)
>
...
> `LambdaCronStack.java`
>
> [LambdaCronStack.java](./IaC_UnitTesting/cdk/java/lambda-cron/src/main/java/software/amazon/awscdk/examples/LambdaCronStack.java)
>
...
> `LambdaCronStackTest.java`
>
> [LambdaCronStackTest.java](./IaC_UnitTesting/cdk/java/lambda-cron/src/test/java/software/amazon/awscdk/examples/LambdaCronStackTest.java)
>
...
> `TestUtils.java`
>
> [TestUtils.java](./IaC_UnitTesting/cdk/java/lambda-cron/src/test/java/software/amazon/awscdk/examples/TestUtils.java)
>
...
> `testCronLambdaExpected.json`
>
> [testCronLambdaExpected.json](./IaC_UnitTesting/cdk/java/lambda-cron/src/test/resources/software/amazon/awscdk/examples/testCronLambdaExpected.json)
>
...
> `lambda-cron.go`
>
> [lambda-cron.go](./IaC_UnitTesting/cdk/go/lambda-cron/lambda-cron.go)
>
...
> `lambda-cron_test.go`
>
> [lambda-cron_test.go](./IaC_UnitTesting/cdk/go/lambda-cron/lambda-cron_test.go)
>
...
**Resources**
  ...
  * [UNIT TEST OF IAC CDK GO](https://www.go-on-aws.com/testing-go/integration/unit_infra/)
...
[![Twitch Video](./assets/DevAx_Connect-AWS_Fargate_Deploying_Java_Springboot_Apps_on_Serverless_Containers.png)](https://www.twitch.tv/videos/620627774)

**Resources**

  * [Springboot Fargate CDK - GitHub Repo](https://github.com/enghwa/springboot-fargate-cdk)

### AWS: TypeScript Examples

#### Full stack with Next.js, Amplify, and CDK

[![Live Coding a Full Stack Serverless App with Next.js, Amazon Aurora Serverless, CDK, & TypeScript - YouTube](http://img.youtube.com/vi/pXd9BCwpjhA/0.jpg)](https://www.youtube.com/watch?v=pXd9BCwpjhA "Live Coding a Full Stack Serverless App with Next.js, Amazon Aurora Serverless, CDK, & TypeScript")

#### Full Stack Cloud with Next.js, Tailwind, and AWS

[![Hands on Workshop - Building a Serverless Multi-user Blogging Platform with Next.js, Tailwind, & AWS - YouTube](http://img.youtube.com/vi/13nYLmjZ0Ys/0.jpg)](https://www.youtube.com/watch?v=13nYLmjZ0Ys "Hands on Workshop - Building a Serverless Multi-user Blogging Platform with Next.js, Tailwind, & AWS")

**Resources**

  * [Full stack with Next.js, Amplify, & CDK - GitHub Repo](https://github.com/dabit3/amplify-with-cdk)
  * [Full Stack Cloud with Next.js, Tailwind, and AWS - GitHub Repo](https://github.com/dabit3/next.js-amplify-workshop)
  
### AWS: Python Examples

#### ML classifier on the cloud with AWS CDK

**Resources**

  * [How to automatically deploy a ML classifier to the cloud with AWS CDK - Blog Post](https://medium.com/axel-springer-tech/how-to-automatically-deploy-a-ml-classifier-to-the-cloud-with-aws-cdk-20f8946d913c)  
  * [How to automatically deploy a ML classifier to the cloud with AWS CDK -GitHub Repo](https://github.com/cschaefer26/ClassifierAWS)
